...
function profilController($twig, $db)
{
    ...
    $user = getOneUser($db, $_SESSION['auth']['id']);

    // Si l'utilisateur ne peut pas être retrouvé, redirection vers l'accueil
    if (!isset($user)) {
        header('Location: /');
        die();
    }
...
//            }
//
//            echo $twig->render('user/form.html.twig', ['form' => $form]);
//
//        }
//    }
